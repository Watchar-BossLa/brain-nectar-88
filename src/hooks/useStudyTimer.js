...
/**
 * Hook for accessing study timer functionality
 * @param {Function} [onComplete] - Callback when timer completes
 * @returns {import('../types/components/timer').TimerContextType} Timer state and methods
 */
export const useStudyTimer = (onComplete) => {
