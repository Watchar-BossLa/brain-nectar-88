...
const SubjectIntegration = ({ currentSubject }) => {
  ...
  const conceptConnections = {
    ...
    economics: [
      ...
      {
        concept: 'Development Economics',
        relatedTo: [
          { subject: 'sociology', concept: 'Social Change', description: 'How economic development affects social structures' },
          { subject: 'environmental science', concept: 'Sustainable Development', description: 'Balancing economic growth with environmental protection' },
          { subject: 'anthropology', concept: 'Cultural Adaptation', description: 'How cultures adapt to economic changes' }
        ]
      },
      {
        concept: 'Financial Economics',
        relatedTo: [
          { subject: 'mathematics', concept: 'Probability Theory', description: 'Mathematical foundations of risk and uncertainty in finance' },
          { subject: 'psychology', concept: 'Risk Perception', description: 'How individuals perceive and respond to financial risks' },
          { subject: 'computer science', concept: 'Financial Modeling', description: 'Computational methods for analyzing financial markets' }
        ]
      }
    ]
  };
