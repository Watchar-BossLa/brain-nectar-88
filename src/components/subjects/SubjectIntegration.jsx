  ...
  const conceptConnections = {
    ...
    literature: [
      ...
      },
      {
        concept: 'Poetic Form',
        relatedTo: [
          { subject: 'mathematics', concept: 'Combinatorics', description: 'Mathematical principles underlie poetic meter and rhyme schemes' },
          { subject: 'music', concept: 'Rhythm and Meter', description: 'Musical concepts of rhythm apply to poetic meter' },
          { subject: 'linguistics', concept: 'Phonology', description: 'Sound patterns in language form the basis of poetic devices' }
        ]
      },
      {
        concept: 'Comparative Literature',
        relatedTo: [
          { subject: 'anthropology', concept: 'Cultural Anthropology', description: 'Cross-cultural study of literary traditions' },
          { subject: 'linguistics', concept: 'Comparative Linguistics', description: 'Language differences affect literary expression' },
          { subject: 'sociology', concept: 'Comparative Sociology', description: 'Social structures influence literary traditions' }
        ]
      }
    ],
    history: [
      ...
      },
      {
        concept: 'Chronology',
        relatedTo: [
          { subject: 'mathematics', concept: 'Number Systems', description: 'Dating systems and calendars rely on mathematical principles' },
          { subject: 'astronomy', concept: 'Celestial Cycles', description: 'Astronomical observations help establish historical chronologies' },
          { subject: 'geology', concept: 'Stratigraphy', description: 'Geological dating methods inform archaeological chronologies' }
        ]
      },
      {
      ...
      {
        concept: 'Historiography',
        relatedTo: [
          { subject: 'philosophy', concept: 'Epistemology', description: 'Philosophical questions about historical knowledge and truth' },
          { subject: 'literature', concept: 'Narrative Theory', description: 'How historical narratives are constructed and interpreted' },
          { subject: 'sociology', concept: 'Sociology of Knowledge', description: 'Social factors that shape historical interpretation' }
        ]
      }
    ]
  };
