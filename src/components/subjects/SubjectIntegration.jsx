  ...
  const conceptConnections = {
    ...
    geography: [
      ...
      },
      {
        concept: 'Climatology',
        relatedTo: [
          { subject: 'physics', concept: 'Thermodynamics', description: 'Physical laws govern climate systems and energy transfer' },
          { subject: 'data science', concept: 'Climate Modeling', description: 'Statistical and computational methods for analyzing climate patterns' },
          { subject: 'history', concept: 'Historical Climatology', description: 'Studying past climate conditions and their effects on human societies' }
        ]
      },
      {
        concept: 'Geopolitics',
        relatedTo: [
          { subject: 'political science', concept: 'International Relations', description: 'Geographic factors influence political relationships between states' },
          { subject: 'history', concept: 'Historical Borders', description: 'Evolution of political boundaries and territorial claims over time' },
          { subject: 'economics', concept: 'Resource Geography', description: 'Distribution of resources affects political and economic power' }
        ]
      }
    ]
  };
