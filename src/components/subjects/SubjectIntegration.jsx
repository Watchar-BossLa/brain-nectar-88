  ...
  const conceptConnections = {
    ...
    psychology: [
      ...
      },
      {
        ...
        relatedTo: [
          { subject: 'medicine', concept: 'Psychiatry', description: 'Medical approaches to mental health disorders' },
          { subject: 'biology', concept: 'Neurochemistry', description: 'Biological basis of psychological disorders' },
          { subject: 'sociology', concept: 'Social Factors in Mental Health', description: 'How social environments influence psychological wellbeing' }
        ]
      },
      {
        concept: 'Research Methods',
        relatedTo: [
          { subject: 'statistics', concept: 'Statistical Analysis', description: 'Statistical methods for analyzing psychological data' },
          { subject: 'data science', concept: 'Data Visualization', description: 'Techniques for visualizing complex psychological data' },
          { subject: 'ethics', concept: 'Research Ethics', description: 'Ethical considerations in psychological research' }
        ]
      }
    ]
  };
