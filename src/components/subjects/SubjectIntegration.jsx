    ...
    music: [
      {
        ...
        relatedTo: [
          { subject: 'mathematics', concept: 'Number Theory', description: 'Mathematical relationships underlie musical intervals and harmony' },
          { subject: 'physics', concept: 'Acoustics', description: 'Physical properties of sound waves determine musical tones and timbre' },
          { subject: 'psychology', concept: 'Auditory Perception', description: 'How the brain processes and interprets musical sounds' }
        ]
      },
      {
        concept: 'Music History',
        relatedTo: [
          { subject: 'history', concept: 'Cultural History', description: 'Music reflects and influences the cultural values of historical periods' },
          { subject: 'sociology', concept: 'Social Movements', description: 'Musical styles often emerge from and influence social changes' },
          { subject: 'art', concept: 'Art Movements', description: 'Parallel developments in musical and artistic movements' }
        ]
      },
      {
        concept: 'Music Composition',
        relatedTo: [
          { subject: 'mathematics', concept: 'Pattern Recognition', description: 'Mathematical structures in musical form and development' },
          { subject: 'psychology', concept: 'Emotional Response', description: 'Psychological impact of musical elements on listeners' },
          { subject: 'computer science', concept: 'Algorithmic Composition', description: 'Computational methods for creating and analyzing music' }
        ]
      },
      {
        concept: 'Music Performance',
        relatedTo: [
          { subject: 'biology', concept: 'Neuromuscular Control', description: 'Biological mechanisms involved in playing instruments' },
          { subject: 'physics', concept: 'Mechanics', description: 'Physical principles in instrument design and performance technique' },
          { subject: 'psychology', concept: 'Performance Psychology', description: 'Psychological factors in musical performance and stage presence' }
        ]
      },
      {
        concept: 'Music and Technology',
        relatedTo: [
          { subject: 'computer science', concept: 'Digital Signal Processing', description: 'Computational methods for recording, synthesizing, and manipulating sound' },
          { subject: 'engineering', concept: 'Audio Engineering', description: 'Technical aspects of sound recording and reproduction' },
          { subject: 'physics', concept: 'Electronics', description: 'Electronic principles in musical instrument and equipment design' }
        ]
      }
    ]
  };
