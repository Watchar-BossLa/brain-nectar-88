...
/**
 * @typedef {import('@/types/flashcard').Flashcard} Flashcard
 */

/**
 * Flashcard Card Component
 * @param {Object} props - Component props
 * @param {Flashcard} props.flashcard - The flashcard to display
 * @param {Function} props.onDelete - Callback when a flashcard is deleted
 * @param {Function} [props.onUpdated] - Callback when a flashcard is updated
 * @param {boolean} [props.isReviewMode] - Whether the card is in review mode
 * @param {Function} [props.onRating] - Callback when a flashcard is rated
 * @returns {React.ReactElement} Flashcard card component
 */
const FlashcardCard = ({ 
  flashcard, 
  onDelete,
